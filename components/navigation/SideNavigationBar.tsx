...
const SideNavigationBar: React.FC = () => {
  ...
  return (
    <aside className=" sm:border-tertiary-200 flex flex-col sm:flex-row justify-start w-full sm:justify-center sm:w-24 2xl:w-48  sticky text-white sm:border-r border-tertiary-100 border-box h-screen">
