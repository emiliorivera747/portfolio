 ...
 *
 *
 * @returns Mission statement component for the primary landing page.
 */
const MissionStatement = () => {
  return (
    <p  className="sm:w-2/3 pl-1 pb-4 sm:pb-10 text-primary-200 font-light mission-statement text-sm sm:text-md">
