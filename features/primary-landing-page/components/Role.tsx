...
const Role = ({ role }: RoleProp) => {
  return (
    <h1 className="font-bold from-primary-700 to-primary-500 bg-gradient-to-r bg-clip-text text-transparent sm:text-2xl text-2xl z-20  sm:mx-1 2xl:text-[2rem] pl-1 sm:pl-0 pb-1">
      {role}
    </h1>
  );
};
