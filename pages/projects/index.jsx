        ...
        <div className="container max-w-6xl mx-auto my-32 px-6 text-gray-900 md:px-0">
          ...
          <div className="flex flex-col w-full space-y-6 text-2xl text-white uppercase md:flex-row md:space-y-0 md:space-x-8">
            <div className="group relative overflow-hidden md:w-1/3">
              ...
              <h5 className="absolute px-6 duration-200 w-52 bottom-4 md-bottom-8 md:px-10 group-hover:scale-110 group-hover:text-black">Casa Chirilagua</h5>
            </div>
            <div className="group relative overflow-hidden md:w-1/3">
              <img
              ...
              {/* Gradient */}
              <div className="absolute top-0 bottom-0 right-0 left-0 bg-gradient-to-b from-transparent to-gray-900 group-hover:from-gray-50 group-hover:to-white group-hover:opacity-70"></div>
              <h5 className="absolute px-6 duration-200 w-52 bottom-4 md-bottom-8 md:px-10 group-hover:scale-110 group-hover:text-black">Portfolio Website</h5>
            </div>
          </div>
        </div>
      </div>
